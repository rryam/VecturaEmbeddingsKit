...
@main
struct VecturaEmbeddingsCLI: AsyncParsableCommand {
  ...
  static let configuration = CommandConfiguration(
    commandName: "vectura-embeddings",
    abstract: "A CLI tool for VecturaEmbeddingsKit-backed VecturaKit databases",
...
@available(macOS 15.0, iOS 18.0, tvOS 18.0, visionOS 2.0, watchOS 11.0, *)
extension VecturaEmbeddingsCLI {
  struct Mock: AsyncParsableCommand {
    ...
    var dbName: String = "vectura-embeddings-cli-demo-db"
    ...
    mutating func run() async throws {
      print("VecturaEmbeddingsKit Mock Demonstration")
      print("=" * 60)
      ...
      // Setup database
      print("\nSetting up database...")
      let db = try await VecturaEmbeddingsCLI.setupDB(
        dbName: dbName,
        dimension: dimension,
  ...
  struct Add: AsyncParsableCommand {
    ...
    @Option(name: [.long, .customShort("d")], help: "Database name")
    var dbName: String = "vectura-embeddings-cli-db"
  ...
  struct Search: AsyncParsableCommand {
    ...
    mutating func run() async throws {
      guard !query.isEmpty else {
        VecturaEmbeddingsCLI.writeError("Error: Query cannot be empty.")
