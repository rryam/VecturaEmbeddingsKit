...
struct TestEmbeddingsExamples {
    ...
    static func main() async {
        print("Starting VecturaEmbeddingsKit validation.")
        ...
        do {
            ...
            print("VecturaEmbeddingsKit initialized through VecturaKit.")
            ...
            print("VecturaEmbeddingsKit validation completed successfully.")
        } catch {
